...
;(function($){
if(!$ || !$.fn) return;
if(!$.fn.bind){ $.fn.bind = function(t,d,f){ return this.on(t,null,d,f); }; }
if(!$.fn.unbind){ $.fn.unbind = function(t,f){ return this.off(t,null,f); }; }
if(!$.fn.delegate){ $.fn.delegate = function(s,t,d,f){ return this.on(t,s,d,f); }; }
if(!$.fn.undelegate){ $.fn.undelegate = function(s,t,f){ return this.off(t,s,f); }; }
if(!$.trim){ $.trim = function(t){ return t == null ? '' : (t + '').trim(); }; }
if(!$.isFunction){ $.isFunction = function(o){ return typeof o === 'function'; }; }
if(!$.type){ $.type = function(o){ return o == null ? String(o) : Object.prototype.toString.call(o).slice(8,-1).toLowerCase(); }; }
if(!$.isArray){ $.isArray = Array.isArray; }
if(!$.isNumeric){ $.isNumeric = function(o){ var t = typeof o; return (t === 'number' || t === 'string') && !isNaN(o - parseFloat(o)); }; }
